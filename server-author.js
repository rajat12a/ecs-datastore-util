const JsonArchive = require( './JsonArchive-author.js' );

const archiveConfig = {
   AUTHOR:{
      kind:'AUTHOR', schema:require( `./schema/AUTHOR.js` ), fileName:'USER/AUTHOR',
      sortBy:'AUTHOR_ID',
...
for( var i = 0; i < archives.length; i++ ) {
  (function run() {
    ...
    if( archive === 'USER_AUTHOR' || archive === 'USER_PRATILIPI' || archive === 'AUTHOR' ) {
