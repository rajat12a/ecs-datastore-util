...
const archiveConfig = {
  ...
  USER_PRATILIPI: {
      sortBy:'_TIMESTAMP_', minValue:new Date(0), maxValue:new Date(1451586600000),
      batchSize:1000, minUpdate:1000,
      timeInt:60, minTimeInt: 15, maxTimeInt:3600, nextRun:0, boost:100 }
};

const bigqueryConfig = {
  AUDIT_LOG: { id:'AUDIT_LOG_ID', api:'/audit-logs', sortBy:'CREATION_DATE', lastValue: '',batchSize:1000, minUpdate:100, timeInt:60, minTimeInt:60, maxTimeInt:900 }
};
